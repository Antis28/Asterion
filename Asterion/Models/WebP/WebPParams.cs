...
namespace Asterion.Models.WebP
{
    public class WebPParams
    {
        ...
        public enum Profile : int { Custom, Default, Photo, Picture, Drawing, Icon, Text }

        public Profile profile = Profile.Default;
        ...
        {            
            ...
            {
                #region Profile other
                switch( profile)
                {
                    case Profile.Default:
                        sb.Append("-preset default ");                      
                        break;
                    case Profile.Drawing:
                        sb.Append("-preset drawing ");
                        break;
                    case Profile.Icon:
                        sb.Append("-preset icon ");
                        break;
                    case Profile.Photo:
                        sb.Append("-preset photo ");
                        break;
                    case Profile.Picture:
                        sb.Append("-preset picture ");
                        break;
                    case Profile.Text:
                        sb.Append("-preset text ");
                        break;
                }
                #endregion
            }
